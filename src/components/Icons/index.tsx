export const FacebookIcon = ({ size }: { size?: number }) => (
  ...
  export const TelegramIcon = ({ className }: { className?: any }) => (
    <svg
      width='24px'
      height='24px'
      viewBox='0 0 32 32'
